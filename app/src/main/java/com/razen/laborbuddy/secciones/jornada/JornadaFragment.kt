...
package com.razen.laborbuddy.secciones.jornada
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if (idUsuario != null) {
            if (idUsuario.isNotEmpty()){
                ...
                if (horaInicioAlmc == "00:00:00" && horaInicioEnviado == "00:00:00") {
                    obtenerHoraSinFin("https://benedictive-writing.000webhostapp.com/appAPI/marcacionPendiente.php", idUsuario)
                }else{
        ...
        btnInicioPausaContinuar.setOnClickListener {
            ...
            if (!isStarted) {
                ...
                if (idUsuario != null) {
                    if (siHayInternet()) {
                        //Insertar horaInicio
                        insertarHoraInicio("https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraInicio.php", currentTime, currentDate, idUsuario)
                    }
                    //verificar permisos de ubicacion para enviar ubicacion
                    verificarPermisosUbicacion("https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionInicio.php", "iniciar")
                }
                ...
                builder.setPositiveButton("Sí") { _, _ ->
                    ...
                    if (idUsuario != null) {
                        if (siHayInternet()) {
                            //insertar hora pausa
                            insertarHora(
                                "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraPausa.php",
                                currentTime,
                                currentDate,
                                idUsuario,
                                "pausa"
                            ...
                            mostrarVentanaNotas(
                                "https://benedictive-writing.000webhostapp.com/appAPI/insertarReportePausa.php",
                                "Pausa"
                            )
                        }
                        //verificar permisos de ubicacion para enviar la ubicacion
                        verificarPermisosUbicacion( "https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionPausa.php", "pausa")
                    }
                }
            ...
            //sino, estará en "Continuar"
                ...
                if (idUsuario != null){
                    if(siHayInternet()){
                        insertarHora("https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraContinuar.php",currentTime, currentDate, idUsuario,"continuar")
                    }
                    verificarPermisosUbicacion("https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionContinuar.php","continuar")
                }
            }
        }
            ...
            if (!refrigerioInicio){
                ...
                if (idUsuario != null) {
                    if (siHayInternet()) {
                        ...
                        insertarHora(
                            "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraInicioRefrigerio.php",
                            currentTime,
                            currentDate,
                            idUsuario,
                            "iniRefri"
                    ...
                    verificarPermisosUbicacion("https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionIniRefri.php", "iniRefri")
                }
            }
        }
            ...
            if(!refrigerioFin) {
                ...
                if (idUsuario != null) {
                    if (siHayInternet()){
                        ...
                        insertarHora(
                            "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraFinRefrigerio.php",
                            currentTime,
                            currentDate,
                            idUsuario,
                            "finRefrigerio"
                    ...
                    verificarPermisosUbicacion("https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionFinRefri.php", "finRefri")
                }
            }
        }
                ...
                builder.setPositiveButton("Sí") { _, _ ->
                    ...
                    if (idUsuario != null){
                        if (siHayInternet()){
                            ...
                            insertarHora(
                                "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraFin.php",
                                currentTime,
                                currentDate,
                                idUsuario,
                                "fin"
                            ...
                            mostrarVentanaNotas(
                                "https://benedictive-writing.000webhostapp.com/appAPI/insertarReporteFin.php",
                                "Fin de Labor"
                            )
                        }
                        //verificar permisos de ubicacion para insertar ubicacion
                        verificarPermisosUbicacion( "https://benedictive-writing.000webhostapp.com/appAPI/insertarUbicacionFin.php", "fin" )
                    }
                }
                builder.setNegativeButton("No") { _, _ ->
                    // Si el usuario selecciona "No", no se realiza ninguna acción y el cuadro de diálogo se cierra
        ...
        tvNuevaMarcacion.setOnClickListener {
            ...
            if (!isReseted) {
                ...
                builder.setMessage(if (siHayInternet()) {
    ...
    private fun obtenerDatosUsuario(url: String) {
        ...
        val request = JsonObjectRequest(
            ...
            { response ->
                ...
                // Verificar si las propiedades existen en la respuesta
                val nombre = if (response.has("nombres")) response.getString("nombres") else ""
                val apellidoP = if (response.has("apellido_P")) response.getString("apellido_P") else ""
                val apellidoM = if (response.has("apellido_M")) response.getString("apellido_M") else ""
                val especialidad = if (response.has("especialidad")) response.getString("especialidad") else ""
                val area = if (response.has("cargo")) response.getString("cargo") else ""
                val rol = if (response.has("rol")) response.getString("rol") else ""
                ...
                editor.putString("especilidad",especialidad).apply()
                        ...
                        if (siHayInternet()) {
                            ...
                            val request = object : StringRequest(
                                ...
                                Response.Listener { response ->
                                    ...
                                    Log.d("InsertarUbicacion", "URL: $url")
                                    Log.d("InsertarUbicacion", "tipo: $accionUbicacion")
                                },
                                Response.ErrorListener { error ->
        ...
        if (idUsuario != null && siHayInternet()) {
            ...
            scope.launch {
                if (horaInicioAlmc != null && horaInicioAlmc != "00:00:00") {
                    insertarHoraInicio(
                        "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraInicio.php",
                        horaInicioAlmc,
                        getCurrentDate(),
                        idUsuario
                    )
                ...
                if (horaContinuarAlmc != null && horaContinuarAlmc != "00:00:00") {
                    insertarHora(
                        "https://benedictive-writing.000webhostapp.com/appAPI/insertarHoraContinuar.php",
                        horaContinuarAlmc,
                        getCurrentDate(),
                        idUsuario,
                        "continuar"
